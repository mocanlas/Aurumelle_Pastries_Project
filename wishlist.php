...
// Handle deleting a specific item from the wishlist
...
// Handle deleting all items from the wishlist
...
<section class="wishlist">
    ...
    <?php
        ...
        // If there are products in the wishlist, display them
        if(mysqli_num_rows($select_wishlist) > 0){
            while($fetch_wishlist = mysqli_fetch_assoc($select_wishlist)){
    ?>
    <!-- Display product details in the wishlist -->
    ...
    <div class="wishlist-total">
        ...
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from wishlist?');">delete all</a>  <!-- Button to delete all items -->
    </div>
